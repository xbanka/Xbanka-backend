...
class Customer(BaseModel):
    ...
    converted: Mapped[bool] = mapped_column(Boolean, default=False, index=True) # has performed Transaction?
    conversion_at:Mapped[DateTime] = mapped_column(DateTime(timezone=True), nullable=True) # time of first transaction
